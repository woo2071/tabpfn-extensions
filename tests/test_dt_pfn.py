...
class TestDecisionTreeClassifier(BaseClassifierTests):
    ...
    @pytest.mark.skip(reason="DecisionTreeTabPFN doesn't fully support pandas DataFrames")
...
class TestDecisionTreeAdvanced:
    ...
    def test_different_max_depths_classifier(self, tabpfn_classifier, classification_data):
        ...
        for i in range(1, len(accuracies)):
            assert accuracies[i] >= accuracies[i-1] - 0.05  # Allow small decrease due to randomness